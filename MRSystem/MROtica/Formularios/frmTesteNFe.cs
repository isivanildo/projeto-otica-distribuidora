...
{
    public partial class frmTesteNFe : Form
    {
        ...
        {
            NFeFuncoesEnvio teste = new NFeFuncoesEnvio();
            string strCaminho = AppDomain.CurrentDomain.BaseDirectory + "Arquivo.tx2";

            StreamReader arquivo = new StreamReader(strCaminho);
        ...
        {
            string caminho = AppDomain.CurrentDomain.BaseDirectory + @"Arquivo.tx2";
