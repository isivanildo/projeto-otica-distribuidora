...
#Region "Enum"
    ...
    Public Enum Fases_os As Integer
        ...
        Laboratório_Surfaçagem = 8
        Laboratório_Controle_de_Qualidade = 9
        Laboratório_Montagem = 10
        Tratamento_Aguardando_Envio = 11
        Tratamento_Aguardando_Retorno = 12
        Concluído_Laboratório = 13
        Enviado_Loja = 14
        Recebido_Loja = 15
        Entregue_Cliente = 16
...
#Region "funções comuns"
    ...
    End Function
    Public Sub uf(ByVal ctr As ComboBox)
        ctr.Items.Add("AC")
        ctr.Items.Add("AL")
        ctr.Items.Add("AP")
        ctr.Items.Add("AM")
