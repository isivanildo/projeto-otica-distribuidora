        ...
        <asp:UpdatePanel ID="UpdatePanel1" runat="server">
            <ContentTemplate>
                <table class="style1">
                    <tr>
                        <td class="style5">
                            &nbsp;<asp:Panel ID="Panel1" runat="server" Width="819px">
                                <asp:Button ID="btnCarrega" runat="server" Text="OK" />
                                <asp:Button ID="btnVoltar" runat="server" Text="Voltar" />
                                <asp:RadioButton ID="rdTodos" runat="server" GroupName="Clientes" 
                                    Text="Todos os Clientes" />
                                <asp:RadioButton ID="rd30Dias" runat="server" Checked="True" 
                                    GroupName="Clientes" Text="Clientes Compraram Últimos 30 dias" />
                                &nbsp;<asp:RadioButton ID="rd30DiasSemCompra" runat="server" GroupName="Clientes" 
                                    Text="Clientes Ativos sem compras nos últimos 30 dias" />
                            </asp:Panel>
                        </td>
                        <td>
                            &nbsp;</td>
                    ...
                    <tr>
                        ...
                        WaitMessageFont-Names="Verdana" WaitMessageFont-Size="14pt" Width="1059px">
                                <LocalReport ReportPath="reports\rptListaClientes.rdlc">
                                </LocalReport>
                            </rsweb:ReportViewer>
                        </td>
                    </tr>
