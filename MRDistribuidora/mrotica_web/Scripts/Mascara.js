...
//Tela de confirmação de Exclusão de registro
...
//Tela de confirmação de Inclusão de registro
...
//Tela de confirmação de cancelamento de registro
function confirmaCancelamento(){
if (confirm('Confirma o cancelamento do registro?')){
return true;
}else{
return false;
}
