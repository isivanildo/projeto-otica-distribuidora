<%@ Page Language="VB" AutoEventWireup="false" CodeFile="resumolabB.aspx.vb" Inherits="resumolabB" %>
    ...
    <table class="style1">
                    <tr>
                        <td class="style3">
                            ...
                            &nbsp;<asp:TextBox ID="txtInicio" runat="server" Width="78px"></asp:TextBox>
                        ...
                        <td>
                            <asp:Label ID="Label3" runat="server" 
                                Text="Total de serviços expedidos no período: "></asp:Label>
