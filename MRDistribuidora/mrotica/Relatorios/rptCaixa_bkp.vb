...
#Region "ActiveReports Designer generated code"
    ...
    Private srVendas As DataDynamics.ActiveReports.SubReport
    ...
    Private Sub InitializeComponent()
        ...
        Me.srVendas = New DataDynamics.ActiveReports.SubReport()
        ...
        Me.Detail.Controls.AddRange(New DataDynamics.ActiveReports.ARControl() {Me.srVendas, Me.srRec, Me.srDesp, Me.sbResumo, Me.SubCredito, Me.sResumoDespesas, Me.srDesc, Me.subCancOS, Me.Subtitulos})
        Me.Detail.Height = 1.759722!
        Me.Detail.Name = "Detail"
        '
        'srVendas
        '
        Me.srVendas.Border.BottomColor = System.Drawing.Color.Black
        Me.srVendas.Border.BottomStyle = DataDynamics.ActiveReports.BorderLineStyle.None
        Me.srVendas.Border.LeftColor = System.Drawing.Color.Black
        Me.srVendas.Border.LeftStyle = DataDynamics.ActiveReports.BorderLineStyle.None
        Me.srVendas.Border.RightColor = System.Drawing.Color.Black
        Me.srVendas.Border.RightStyle = DataDynamics.ActiveReports.BorderLineStyle.None
        Me.srVendas.Border.TopColor = System.Drawing.Color.Black
        Me.srVendas.Border.TopStyle = DataDynamics.ActiveReports.BorderLineStyle.None
        Me.srVendas.CloseBorder = False
        Me.srVendas.Height = 0.125!
        Me.srVendas.Left = 0.0!
        Me.srVendas.Name = "srVendas"
        Me.srVendas.Report = Nothing
        Me.srVendas.Top = 0.0!
        Me.srVendas.Visible = False
        Me.srVendas.Width = 7.5!
        '
        'srRec
        '
        ...
        Me.sResumoDespesas.Left = 0.0!
        Me.sResumoDespesas.Name = "sResumoDespesas"
        Me.sResumoDespesas.Report = Nothing
        Me.sResumoDespesas.Top = 1.1875!
        Me.sResumoDespesas.Width = 7.5!
        '
        'srDesc
        '
...
#End Region
    ...
    Private Sub Detail_Format(ByVal sender As Object, ByVal e As System.EventArgs) Handles Detail.Format
        ...
        Try
            ...
            If fatura.listaDescontosDia(diai, conf.Filial).Rows.Count = 0 Then
                srDesc.Visible = False
            End If
        Catch ex As Exception
        ...
        Try
            ...
            If lanc.listar_despesas_data(diai, diaf, conf.Filial).Rows.Count = 0 Then
        ...
        End Try
        Try
            rpttitulos.diai = diai
            rpttitulos.diaf = diaf
