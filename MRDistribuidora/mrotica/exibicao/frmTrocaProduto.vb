...
entrada_od:
                ...
                If dev.max = 0 Then
                    ...
                    nova_devolucao()
                End If
                'insere movimento de entrada da peça.
                ...
                mov.historico = "Devolução para estoque olho direito. Nº da devolução " & dev.cod_devolucao_os &
...
entrada_oe:
                ...
                mov.historico = "Devolução para estoque olho esquerdo. Nº da devolução " & dev.cod_devolucao_os &
                " da OS. " & dev.id_filial_os & "-" & dev.cod_os
                mov.Salvar()
                txtCodBarraOE.Enabled = False
                andamentos.insere_andamento(objAndamentos.tipo.devolucao_estoque, dev.id_filial, dev.cod_os, UserID,
