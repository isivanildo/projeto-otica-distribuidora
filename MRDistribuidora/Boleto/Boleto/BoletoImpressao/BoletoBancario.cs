    ...
    public class BoletoBancario : Control
    {
        ...
        private string MontaHtml(string urlImagemLogo, string urlImagemBarra, string imagemCodigoBarras)
        {
            ...
            return html
                ...
                //.Replace("@DESCONTOS", "") antes de eu alterar
                ...
                .Replace("@INSTRUCOES", Boleto.MensagemInstrucoesCaixa + (Boleto.ValorDesconto == 0 ? "" :  "<br> DESCONTO DE " + Boleto.ValorDesconto.ToString("R$ ##,##0.00") + " ATÉ O VENCIMENTO."));
        }
